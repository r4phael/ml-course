...
# Fitting the Naive Bayes classifier with Training set
...
plot_results_class(X_train, y_train, classifier, 'Naive Bayes (Training set)')

# Plotting the test set results
plot_results_class(X_test, y_test, classifier, 'Naive Bayes (Test set)')# -*- coding: utf-8 -*-
