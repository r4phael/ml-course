...
# Fitting the classifier SVC with Training set
classifier = SVC(kernel = 'linear', random_state = 0)

# Fitting the classifier SVC with different kernel
...
plot_results_class(X_train, y_train, classifier, 'SVC (Training set)')

# Plotting the test set results
plot_results_class(X_test, y_test, classifier, 'SVC (Test set)')