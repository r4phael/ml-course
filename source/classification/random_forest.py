...
# Fitting the Random Forest classifier with Training set
...
plot_results_class(X_train, y_train, classifier, 'Random Forest (Training set)')

# Plotting the test set results
plot_results_class(X_test, y_test, classifier, 'Random Forest(Test set)')# -*- coding: utf-8 -*-
